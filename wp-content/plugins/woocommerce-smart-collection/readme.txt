...
Contributors: downtown2017, arimghosh
...
* Compatible with Woocommerce 2.0.x, 2.1.x, 2.2.x, 2.3.x and 2.4.x
...
Yes, this plugin works really fine up to Wordpress 4.6! It is also compatible with older Wordpress versions, down to 3.0.

= Does this plugin work with newest Woocommerce version and also older versions? =
Yes, this plugin works really fine with Woocommerce 2.4.x! It is also compatible with older versions of woocommerce.
