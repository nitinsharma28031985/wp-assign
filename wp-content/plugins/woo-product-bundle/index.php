...
! defined( 'WOOSB_VERSION' ) && define( 'WOOSB_VERSION', '3.3.7' );
		...
		if ( ! class_exists( 'WC_Product_Woosb' ) && class_exists( 'WC_Product' ) ) {
			class WC_Product_Woosb extends WC_Product {
				...
				public function add_to_cart_text() {
					if ( $this->is_purchasable() && $this->is_in_stock() ) {
						if ( ! $this->has_variables() && ! $this->is_optional() ) {
							$text = get_option( '_woosb_archive_button_add', esc_html__( 'Add to cart', 'woo-product-bundle' ) );
						} else {
							$text = get_option( '_woosb_archive_button_select', esc_html__( 'Select options', 'woo-product-bundle' ) );
						}
					} else {
						$text = get_option( '_woosb_archive_button_read', esc_html__( 'Read more', 'woo-product-bundle' ) );
					}
				...
				public function single_add_to_cart_text() {
					$text = get_option( '_woosb_single_button_add', esc_html__( 'Add to cart', 'woo-product-bundle' ) );
                        ...
                        <div class="wpclever_settings_page_nav">
                            <h2 class="nav-tab-wrapper">
                                <a href="?page=<?php echo $page_slug; ?>&amp;tab=how"
                                   class="nav-tab <?php echo $active_tab == 'how' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'How to use?', 'woo-product-bundle' ); ?></a>
                                <a href="?page=<?php echo $page_slug; ?>&amp;tab=settings"
                                   class="nav-tab <?php echo $active_tab == 'settings' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Settings', 'woo-product-bundle' ); ?></a>
                                <a href="?page=<?php echo $page_slug; ?>&amp;tab=tools"
                                   class="nav-tab <?php echo $active_tab == 'tools' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Tools', 'woo-product-bundle' ); ?></a>
                                <a href="?page=<?php echo $page_slug; ?>&amp;tab=premium"
                                   class="nav-tab <?php echo $active_tab == 'premium' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Premium Version', 'woo-product-bundle' ); ?>
                                </a>
                            </h2>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="_woosb_archive_button_add"
                                                       value="<?php echo get_option( '_woosb_archive_button_add', esc_html__( 'Add to cart', 'woo-product-bundle' ) ); ?>"/>
                                                <span class="description">
											<?php esc_html_e( 'For purchasable bundle.', 'woo-product-bundle' ); ?>
										</span><br/>
                                                <input type="text" name="_woosb_archive_button_select"
                                                       value="<?php echo get_option( '_woosb_archive_button_select', esc_html__( 'Select options', 'woo-product-bundle' ) ); ?>"/>
                                                <span class="description">
											<?php esc_html_e( 'For purchasable bundle and has variable product(s).', 'woo-product-bundle' ); ?>
                                                ...
                                                <input type="text" name="_woosb_archive_button_read"
                                                       value="<?php echo get_option( '_woosb_archive_button_read', esc_html__( 'Read more', 'woo-product-bundle' ) ); ?>"/>
                                                <span class="description">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="_woosb_single_button_add"
                                                       value="<?php echo get_option( '_woosb_single_button_add', esc_html__( 'Add to cart', 'woo-product-bundle' ) ); ?>"/>
                                            </td>
                                        </tr>
                                        <tr class="heading">
                                            <th colspan="2">
							...
							<?php } elseif ( $active_tab == 'tools' ) { ?>
                                <table class="form-table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
											<?php
									if ( isset( $_GET['woosb_wup'] ) && wp_verify_nonce( $_GET['woosb_wup'], 'woosb_update_price' ) ) {
										self::woosb_update_price( true );
										echo '<p class="woosb_updated_price" style="color: green;">' . esc_html__( 'Updated!', 'woo-product-bundle' ) . '</p>';
									}
									?>
                                            <a class="button button-large"
                                               href="<?php print wp_nonce_url( admin_url( 'admin.php?page=wpclever-woosb&tab=tools' ), 'woosb_update_price', 'woosb_wup' ); ?>">
												<?php esc_html_e( 'Update price for all bundles', 'woo-product-bundle' ); ?></a>
                                            <p class="description">
                    ...
                    <div id='woosb_settings' class='panel woocommerce_options_panel woosb_table'>
                        <table>
                            ...
                            <tr class="woosb_tr_space">
                                ...
                                <td style="font-style: italic">
                                    <input id="woosb_disable_auto_price" name="woosb_disable_auto_price"
                                           type="checkbox" <?php echo( get_post_meta( $post_id, 'woosb_disable_auto_price', true ) == 'on' ? 'checked' : '' ); ?>/> <?php echo sprintf( esc_html__( 'Disable auto calculate Regular price? If yes, %s click here to set Regular price %s', 'woo-product-bundle' ), '<a id="woosb_set_regular_price">', '</a>' ); ?>
                                </td>
                            </tr>
                            <tr class="woosb_tr_space">
                            ...
                            <tr class="woosb_tr_space woosb_tr_show_if_optional_products">
                                <th><?php esc_html_e( 'Limit each item', 'woo-product-bundle' ); ?></th>
                                <td>
                            ...
                            <tr class="woosb_tr_space woosb_tr_show_if_optional_products">
                                <th><?php esc_html_e( 'Limit whole items', 'woo-product-bundle' ); ?></th>
                                <td>
				...
				function woosb_show_items() {
					...
					if ( $woosb_items = $product->get_items() ) {
                        ...
                        <table cellspacing="0" class="woosb_products woosb-table woosb-products"
                               ...
                               data-min="<?php echo esc_attr( get_post_meta( $product_id, 'woosb_limit_whole_min', true ) ? get_post_meta( $product_id, 'woosb_limit_whole_min', true ) : 0 ); ?>"
							...
							<?php foreach ( $woosb_items as $woosb_item ) {
                                ...
                                <tr class="woosb-product"
                                    ...
                                    data-qty="<?php echo esc_attr( $woosb_product->is_in_stock() ? $woosb_item['qty'] : '0' ); ?>">
